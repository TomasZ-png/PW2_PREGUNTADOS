...
CREATE TABLE usuario(
    ...
    nivel_usuario VARCHAR(100) DEFAULT 'APRENDIZ',
    puntaje_global INT,
...
CREATE TABLE pregunta(
    ...
    dificultad VARCHAR(50) DEFAULT 'NUEVA',
    categoria VARCHAR(100),
    puntaje INT,
    cant_acertadas INT DEFAULT 0,
    cant_erroneas INT DEFAULT 0,
    fecha_creacion DATE
);
...
INSERT INTO pregunta (pregunta,  categoria, puntaje, fecha_creacion) VALUES
